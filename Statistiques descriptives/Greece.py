...
plt.title('Repartition of Farm Types in Greece, based on the number of holdings')

plt.show()

"""5. Drawing a pie chart plotting the distribution of the used agricultural 
area in Greece by farm types."""

csv_file = "/Users/cyrillefougere/Desktop/ENSAE 2023:2024/S1/Python et Data Science/Databases/Greece_Non-Organic_Used area (ha).csv"
...
plt.title('Distribution of Used Agricultural Area by Farm Type, in Greece')
plt.show()
